	...
	<div id="mainmenu">
		<?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
				...
				array('label'=>'Offer a ride', 'url'=>array('/sharing/offer')),
				array('label'=>'Browse ride', 'url'=>array('/sharing/searchRide')),
				array('label'=>'Browse user', 'url'=>array('/user/user/browse')),
